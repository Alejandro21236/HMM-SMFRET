...
# === Input files ===
topology_file = "/scratch/FRET_true/DNAbound/SYS_nowat.pdb"
trajectory_file = "/scratch/FRET_true/DNAbound/traj_1550ns.dcd"
...
time_per_frame_ns = 1550 / len(u.trajectory)
...
df.to_csv("/scratch/FRET_true/DNAbound/DNA.csv", index=False)
