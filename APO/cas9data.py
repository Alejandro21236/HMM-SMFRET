...
# === Input files ===
topology_file = "/scratch/FRET_true/APO/SYS_nowat.pdb"
trajectory_file = "/scratch/FRET_true/APO/traj_1400ns.dcd"
...
time_per_frame_ns = 1400 / len(u.trajectory)
...
df.to_csv("/scratch/FRET_true/APO/APO.csv", index=False)
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/scratch/FRET_true/APO/fret_efficiency_vs_time.png")
plt.show()
...
plt.tight_layout()
plt.savefig("/scratch/FRET_true/APO/fret_efficiency_histogram.png")
plt.show()
